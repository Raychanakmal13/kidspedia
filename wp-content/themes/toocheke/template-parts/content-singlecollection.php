...
if ($chapters_list) {
    ?>
                ...
                <div id="chapter-wrapper">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 id="latest-chapters-header" class="left-title"><?php echo (esc_html(get_theme_mod('latest_chapter_setting')) != "") ? esc_html(get_theme_mod('latest_chapter_setting')) : esc_html_e('Latest Chapters', 'toocheke') ?></h2>
                        </div>
                        <?php
    ...
    ?>
                    ...
                    <div class="col-md-12 more-chapters-wrapper">
                        <a class="btn btn-danger btn-xs"
                            href="<?php echo esc_url(add_query_arg('sid', $series_id, get_permalink(get_page_by_path('chapters')))) ?>"
